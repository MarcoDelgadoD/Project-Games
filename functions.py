...
# En este apartado, nos centraremos en consumir los archivos que se generaron en el notebook Consultas,
# que serán utilizados por la API. El objetivo principal es dar respuestas a los
# Endpoints y a los Modelos Machine Learning, garantizando rapidez y eficacia en la ejecución de la API.
