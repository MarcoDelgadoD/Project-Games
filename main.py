...
import pandas as pd
from functions import PlayTimeGenre, UserForGenre, UsersRecommend, UsersWorstDeveloper, sentiment_analysis, recomendacion_usuario
...
async def root():
    ...
    """
    return {"Proyecto Individual N° 1" : "Marco Delgado"}
...
@app.get("/sentiment_analysis/{empresa_desarrolladora}", tags=["SentimentAnalysis"])
...
@app.get("/recomendacion_usuario/{item_id}", tags=["Modelo_ML"])
